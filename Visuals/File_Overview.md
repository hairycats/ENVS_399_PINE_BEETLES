...
**Climate_Visuals.Rmd** - The file that we used for most of the R figures that ended up being used. the FEM and PRISM data is used in this file with the good climate variables. 

The other files in this folder are just different variations of these three files in different formats. 
